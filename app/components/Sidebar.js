...
export function Sidebar({ filters, selectedCategories, onToggleCategory, hidden, onClose }) {
  return (
    <>
      ...
      `}>
        <div className="p-6 border-b border-neutral-800 flex items-center justify-between pt-[calc(1.5rem+env(safe-area-inset-top))] lg:pt-6">
          <h1 className="text-xl font-black tracking-tighter text-white flex items-center gap-2.5">
          ...
          <button 
            onClick={onClose}
            className="p-2 rounded-lg hover:bg-neutral-800 lg:hidden text-neutral-400"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="p-4 overflow-y-auto flex-1 custom-scrollbar pb-[calc(1rem+env(safe-area-inset-bottom))]">
          <div className="mb-4 px-3 text-[10px] font-bold text-neutral-500 uppercase tracking-[0.2em]">
            Categories
          </div>
                ...
                <button
                  ...
                  className={`
                    ...
                    ${isSelected 
                      ...
                      : 'text-neutral-400 hover:bg-neutral-800/50 hover:shadow-sm'}
                  `}
                >
                  <div className={`
                    ...
                    ${isSelected
                      ...
                      : 'border-neutral-600 group-hover:border-blue-400'}
                  `}>
